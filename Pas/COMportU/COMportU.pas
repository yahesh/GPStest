...
(*
  Copyright Owner: coltishWARE (Kevin Niehage)
  Copyright Year : 2008

  Unit   : COMportU (platform dependant)
  Version: 1.3c

  Contact E-Mail            : development@coltishWARE.com
  Contact Mobile            : +49-(0)-177-69-4321-8
  Contact Telephone Berlin  : +49-(0)-30-69-20-96-78
  Contact Telephone Cottbus : +49-(0)-355-28925-88-17-55
  Contact Telephone Mannheim: +49-(0)-621-483-4664
*)
// Please, don't delete this comment. \\
...
const
  COMportU_CopyrightOwner = 'coltishWARE (Kevin Niehage)';
  COMportU_CopyrightYear  = '2008';
...
begin
  ...
  begin
    if (FNumber >= 10) then
      ...
      Result := OpenCOMhandle(CCOMportShort + IntToStr(FNumber));
    if Result then
    begin
      FLineBuffer := '';
